...
const Insights = () => {
  ...
  function getCanonicalUrl(arg0: string): string | undefined {
    ...
    "itemListElement": [
      {
        ...
        "position": 1,
        "name": "Home",
        "item": "https://www.cubeaisolutions.com"
      },
      {
        "@type": "ListItem",
        "position": 2,
        "name": "Insights",
        "item": "https://www.cubeaisolutions.com/insights"
      }
    ]
  };
  ...
  const organizationSchema = {
    ...
    "logo": "https://www.cubeaisolutions.com/image/logo.png",
    "sameAs": ["https://twitter.com/CubeAISolutions"]
  };
  ...
  return (
    ...
    >
      <Head>
        ...
        <meta
          name="keywords"
          content={baseInsightKeywords}
        />
        <link rel="canonical" href={getCanonicalUrl('/insights')} />

        {/* Open Graph Meta Tags */}
        <meta property="og:title" content="CubeAI Insights - AI & ML Trends Knowledge Hub" />
        <meta property="og:description" content="Explore CubeAI Insights: Unlock deep insights, predictive trends, and transformative strategies in AI, machine learning, and innovation." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.cubeaisolutions.com/insights" />
        <meta property="og:image" content="https://www.cubeaisolutions.com/image/og-insights.jpg" />
        <meta property="og:site_name" content="CubeAI Solutions" />

        {/* Twitter Card Meta Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="CubeAI Insights - AI & ML Trends Knowledge Hub" />
        <meta name="twitter:description" content="Explore CubeAI Insights: Unlock deep insights, predictive trends, and transformative strategies in AI, machine learning, and innovation." />
        <meta name="twitter:image" content="https://www.cubeaisolutions.com/image/og-insights.jpg" />
        <meta name="twitter:site" content="@CubeAISolutions" />
      ...
      <div className="container mx-auto px-4 lg:px-6 relative z-10">
        ...
        <div className="text-center mb-16" data-aos="fade-down">
          <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
            <span className="text-purple-600">Insights</span> & Knowledge Hub
          </h1>
          <h2 className="text-2xl md:text-3xl font-semibold text-gray-700 mb-4">
            Explore AI Trends, Machine Learning Innovations & Industry Insights
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Dive into expert perspectives on artificial intelligence, emerging technologies, and digital transformation strategies.
          </p>
        </div>
