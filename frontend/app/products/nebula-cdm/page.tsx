...
export default function NebulaCDMPage() {
    ...
    const product = {
        ...
        bgImage: '/assets/products/cdm.webp',
        productImage: '/assets/products/cdm1.webp',
        keyFeatures: [
        ...
        benefits: [
            {
                ...
                image: '/assets/products/cdm2.webp',
            },
            {
                icon: Target,
                ...
                image: '/assets/products/cdm3.webp',
            },
            {
                icon: Zap,
                ...
                image: '/assets/products/cdm4.png',
            },
        ],
    };
