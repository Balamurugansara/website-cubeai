...
export default function CosmosPage() {
    ...
    const product = {
        ...
        bgImage: '/assets/products/cos.webp',
        productImage: '/assets/products/Cos1.webp',
        keyFeatures: [
